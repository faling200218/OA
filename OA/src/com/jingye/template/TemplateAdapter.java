...
public class TemplateAdapter extends BaseAdapter{
	...
	public TemplateAdapter(Context context,List<HashMap<String, String>> fileData){
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    if(convertView == null){
	      ...
	      holder.fileName = (TextView)convertView.findViewById(R.id.template_name);
	...
	/*    holder.fileSize = (TextView)convertView.findViewById(R.id.file_size);
	    ...
	    holder.fileName.setText(fileData.get(position).get("groupname").toString());
